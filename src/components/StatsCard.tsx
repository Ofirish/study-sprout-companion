    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4 sm:mt-8" dir={language === "he" ? "rtl" : "ltr"}>
      ...
      <Button
        ...
        className={`relative flex flex-col items-center justify-center p-4 hover:bg-gray-100 rounded-lg transition-all h-auto ${
          currentFilter === 'completed' ? 'ring-2 ring-[#0EA5E9] ring-offset-2 shadow-lg' : 'shadow hover:shadow-md'
        }`}
      >
      ...
      <Button
        ...
        className={`relative flex flex-col items-center justify-center p-4 hover:bg-gray-100 rounded-lg transition-all h-auto ${
          currentFilter === 'in_progress' ? 'ring-2 ring-[#0EA5E9] ring-offset-2 shadow-lg' : 'shadow hover:shadow-md'
        }`}
      >
      ...
      <Button
        ...
        className={`relative flex flex-col items-center justify-center p-4 hover:bg-gray-100 rounded-lg transition-all h-auto ${
          currentFilter === 'not_started' ? 'ring-2 ring-[#0EA5E9] ring-offset-2 shadow-lg' : 'shadow hover:shadow-md'
        }`}
      >
